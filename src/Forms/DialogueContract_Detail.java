...
public class DialogueContract_Detail extends JDialog {
    private static DialogueContract_Detail Dialogue;
    private JPanel contentPane;
    private JButton buttonOK;
    private JButton buttonCancel;

    public DialogueContract_Detail() {
    ...
    public static void main() {
        if (Dialogue == null){
            Dialogue = new DialogueContract_Detail();
        }
